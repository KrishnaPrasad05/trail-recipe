...
function IndianChineseRecipe() {
    ...
    const fetchRecipe = async () => {
        try {
            const response = await fetch('http://localhost:5000/api/recipes/recipe?recipeType=Indo-Chinese+Recipe');
            if (response.ok) {
...
export default IndianChineseRecipe;
