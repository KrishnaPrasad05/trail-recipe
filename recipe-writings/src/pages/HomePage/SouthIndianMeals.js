...
function SouthIndianMeals() {
    ...
    const fetchRecipe = async () => {
        try {
            const response = await fetch('http://localhost:5000/api/recipes/recipe?recipeType=South+Indian+Meals');
            if (response.ok) {
...
export default SouthIndianMeals;
